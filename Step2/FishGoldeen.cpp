...
*/
CFishGoldeen::CFishGoldeen(CAquarium* aquarium) : CItem(aquarium)
{
	mFishImage = unique_ptr<Bitmap>(Bitmap::FromFile(FishGoldeenImageName.c_str()));
	if (mFishImage->GetLastStatus() != Ok)
	{
		wstring msg(L"Failed to open ");
		msg += FishGoldeenImageName;
 ...
 */
void CFishGoldeen::Draw(Gdiplus::Graphics* graphics)
{
